    ...
    child: Row(
      children: [
        CircleAvatar(
          ...
          child: Text(l, style: const TextStyle(color: Color(0xFFD64550), fontWeight: FontWeight.w600)),
        ),
          ...
          child: Visibility(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: CustomButton(prefixIcon: Icon(Icons.send,color:  Colors.black), text: "Transfer", height: 40, btncolor: Colors.white,textColor: Colors.black,  onPressed: () {
                 Get.toNamed("/sendmoney");     
                  },),
                ),
                width6,
                Expanded(
                  child: CustomButton(prefixIcon: Icon(Icons.add,color:  Colors.black), text: "Top-up",  height: 40, btncolor: Colors.white,textColor: Colors.black, onPressed: () {
